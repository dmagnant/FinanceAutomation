...
def runIoPay(driver, account, book):
    ...
    walletBalancePath = '/html/body/div[1]/section/div[2]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[2]/div[2]/p[2]'
    try:
    ...
    if walletBalance > 5:
        driver.clickXPATHElementOnceAvaiable('/html/body/div[1]/section/div[2]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[1]/div[2]/div/div[2]/div[1]/div/div[2]/div[6]/div/button') # action
    ...
    walletBalance = Decimal(driver.getXPATHElementTextOnceAvailable(walletBalancePath, 15).replace(" IOTX", ""))
    stakedBalance = Decimal(driver.webDriver.find_element(By.XPATH,"/html/body/div[1]/section/div[2]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[2]/div[3]/p[2]").text.replace(" IOTX", "").replace(',',''))
