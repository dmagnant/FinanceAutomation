...
def runIoPay(driver, account, book):
    ...
    if walletBalance > 5:
        driver.webDriver.find_element(By.XPATH,'/html/body/div[1]/section/div[1]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[1]/div/div/div[2]/div[1]/div/div[2]/div[6]/div/button').click() # action
    ...
    walletBalance = Decimal(driver.webDriver.find_element(By.XPATH,"/html/body/div[1]/section/div[1]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[2]/div[2]/p[2]").text.replace(" IOTX", ""))
    stakedBalance = Decimal(driver.webDriver.find_element(By.XPATH,"/html/body/div[1]/section/div[1]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[2]/div[3]/p[2]").text.replace(" IOTX", "").replace(',',''))
