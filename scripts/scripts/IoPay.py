...
def runIoPay(driver, account, book):
    ...
    if walletBalance > 5:
        driver.clickXPATHElementOnceAvailable('/html/body/div[1]/section/div[1]/main/div/div[5]/div[2]/div[2]/div[3]/div[2]/div[1]/div[2]/div/div[2]/div[1]/div/div[2]/div[6]/div/button') # action
