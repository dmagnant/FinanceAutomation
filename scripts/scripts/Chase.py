...
def chaseLogin(driver):
    ...
    while n<=8:
        ...
        n+=1
    try:
        driver.webDriver.find_element(By.ID,"signin-button").click() # Sign In
    ...
    try:
        ...
        exception = 'device already recognized'       
...
def claimChaseRewards(driver):
    ...
    if float(balance) > 0:
        ...
        # driver.webDriver.find_element(By.XPATH, "/html/body/the-app/main/ng-component/section[2]/div/section[1]/div[2]/form/div[5]/div[1]/div[1]/div[1]/div/selectable-tile/div/mds-fieldset/div/mds-selectable-tile//div/div[1]/div/input").click()
        # pyautogui.press('tab')
        # pyautogui.press('enter')
        # time.sleep(2)
